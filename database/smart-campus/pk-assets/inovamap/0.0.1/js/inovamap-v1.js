          ...
          if(response.features.length > 0)
          {
            ...
            response.features.forEach(function(feature){
              ...
              if (id.toLowerCase().indexOf("gedung") >= 0){
                ...
                content.innerHTML = '<p>Nama Gedung : '+ name +'<br/>Link Gallery Gedung <br/>Foto Gedung</p>';
            ...
            $.each(results, function(i, item){
              $.each(item, function(j, value) {
                ...
                $.each(value, function(k, realVal) {
                  ...
                  var namaItem = (realVal.nm_gedung) ? realVal.nm_gedung : realVal.nm_ruangan;
                  body = '<li style="padding: 5px;" onClick="CenterMapGeometry(\'' + wkt + '\'' + ',' + '\'' + namaItem + '\')"><img style="margin-right: 10px;" src="/assets/images/office-block.svg" class="img-responsive pull-left" width="20px">'+ namaItem + '</li><hr>';
    ...
    switch(value) {
      ...
      map.getLayers().forEach(function(layer){
        layer.getLayers().forEach(function(lyr){
          ...
          } else if(lyr.get('name') == "Gedung-ITB")
		  {
		    lyr.setVisible(true);
		  }
        });     
